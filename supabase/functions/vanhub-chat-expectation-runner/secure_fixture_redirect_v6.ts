// @ts-nocheck
// Application-level operator authorization is enforced before the reviewed QA
// runner can construct a service-role client or write QA state. Supabase gateway
// JWT verification remains enabled as a separate outer control.
...
await import('./fixture_redirect_v5.ts')
