...
import {reduce,prompt} from '../../supabase/functions/vanhub-chat-kernel/flow56_release_controller53.ts'
...
const fixtureFiles=['recorded-extractor-v1.jsonl','recorded-extractor-v2.jsonl','recorded-extractor-v3.jsonl','recorded-extractor-v4.jsonl','recorded-extractor-v5.jsonl']
const cases=[]
